          ...
          <div className="w-2/3 p-4 border-r border-white/30 flex flex-col">
            ...
            >
              ...
              <div className=" h-full w-full">
                <TFTBoardContainer
                  champions={champions}
                  onDropChampion={null as any}
                  onRemoveChampion={null as any}
                  placedChampions={build.data[currentPhase + ""].boardChampions}
                  ...
                  ? augments.map((augment, index) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-300">
                          {augment.description || (augment as any).desc}
                        </p>
                      </div>
                    ))
